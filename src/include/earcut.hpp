...
namespace mapbox
{
    ...
    std::vector<sf::Vector2f> earcutShape(const std::vector<sf::Vector2f> &verts);
    ConcaveHitbox earcutHitbox(const std::vector<sf::Vector2f> &verts);
    std::pair<std::vector<sf::Vector2f>, ConcaveHitbox> earcutShapeAndHitbox(const std::vector<sf::Vector2f> &verts);
}
